...
public class WechatConfig {
     ...
     * appId
     */
    public static final String VxAppId = "wx362f8f3a237038a0";

    /**
     * 你的微信的密钥
     * appSecret
     */
    public static final String VxAppSecret = "458010b5a7a0f0cf86bcbbfe8ebf1c96";
    ...
    static {
        userList.add(getUser(
                "o1ef45xX6oyQ0k5f4NO6FBth3imI", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "FROjQKopNBqxQxBzh4W1OBfKAH0JKiIk9qvW6FfuYic", //要给这个人发送的模板ID
                "小刘同学 ", //咋称呼这个人
                "山东省济南市历城区", //这个人的详细地址
                "济南", //这个人在的城市
                new BirthDay(2000,10,12,false,false,"pt生日快乐！！"),
                new BirthDay(2000,9,15,true,false,"生日快乐哦~~"),
                new BirthDay(2013,9,1,true,true),
                new BirthDay(2013,9,1,false,false,"周年快乐！！！")
        ));
